        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline" style=" width: 350px;">
                    ...
                    大堂职员<input type="radio" name="role" value="1" lay-verify="required" autocomplete="off"
                                   class="layui-input">
                    酒店经理<input type="radio" name="role" value="2" lay-verify="required" autocomplete="off"
                                   class="layui-input">
                    酒店后勤<input type="radio" name="role" value="3" lay-verify="required" autocomplete="off"
                                   class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
